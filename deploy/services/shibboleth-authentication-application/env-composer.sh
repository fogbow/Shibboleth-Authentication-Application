...
GENERAL_RAS_PUBLIC_KEY_PATTERN="ras_public_key_path"

SHIB_PRIVATE_KEY_NAME="/shib_private.key"
RAS_PUBLIC_KEY_NAME="/ras_private.key"

# Moving files to deployment directory
GENERAL_SHIB_PRIVATE_KEY_PATH=$(grep $GENERAL_SHIB_PRIVATE_KEY_PATTERN $GENERAL_CONF_FILE_PATH | awk -F "=" '{print $2}')
GENERAL_RAS_PUBLIC_KEY_PATH=$(grep $GENERAL_RAS_PUBLIC_KEY_PATTERN $GENERAL_CONF_FILE_PATH | awk -F "=" '{print $2}')
yes | cp -f $GENERAL_SHIB_PRIVATE_KEY_PATH $BASE_CONF_FILES_DIR$SHIB_PRIVATE_KEY_NAME
yes | cp -f $GENERAL_RAS_PUBLIC_KEY_PATH $BASE_CONF_FILES_DIR$RAS_PUBLIC_KEY_NAME
...
RAS_PUBLIC_KEY_PATTERN="ras_public_key_path"
RAS_PUBLIC_KEY=$CONTAINER_FILES_DIR_PATH$RAS_PUBLIC_KEY_NAME
sed -i "s#.*$RAS_PUBLIC_KEY_PATTERN=.*#$RAS_PUBLIC_KEY_PATTERN=$RAS_PUBLIC_KEY#" $SHIB_AUTH_APP_DIR/$SHIB_AUTH_APP_CONF_FILE
